...
<body>
	<table id="report1">
		<tr style="">
			<th><fmt:message key="table_of_drivers.col1" /></th>
			<th><fmt:message key="table_of_drivers.col2" /></th>
			<th><fmt:message key="table_of_drivers.col3" /></th>
			<th><fmt:message key="table_of_drivers.col4" /></th>
			<th><fmt:message key="table_of_drivers.col5" /></th>
			<th><fmt:message key="table_of_drivers.col6" /></th>
			<th><fmt:message key="table_of_drivers.col7" /></th>
			<th><fmt:message key="table_of_drivers.col8" /></th>
			<th><fmt:message key="table_of_drivers.col9" /></th>
			<th></th>
		</tr>
				...
				<td>
					<form action="controller" method="post">
						...
						<button type="submit" name="command" value="hr.FireDriver">
							<em><fmt:message key="table_of_drivers.fire" /></em>
						</button>
					</form>
				</td>
