...
<body>
	...
	<button class="button small blue" type="submit" name="command"
						value="ChangeLanguage" style="margin-right:5em; margin-top:0em"><fmt:message key="main.change_language"/></button>
	</form>
					...
					<div style="background-color: transparent" class="logo-wrapper">
						<h1 class="logo">
							<a rel="nofollow" href="controller?command=MainPage"><img
								...
								<span style="color: white; font-size: 15px"><fmt:message key="cabinet.welcome"/></span></a>
						</h1>
					</div>
					<!-- /.logo-wrapper -->
					...
					<div class="menu-wrapper">
						<ul class="menu">
							<li><a class="homebutton" href="#"><em
									style="font-size: 14px; color: grey"><fmt:message key="cabinet.hide"/></em></a></li>
							<li><a class="show-1" href="#"><fmt:message key="admin_page.manage"/></a></li>
							<li><a class="show-2" href="#"><fmt:message key="admin_page.financial"/></a></li>
							<li><a class="show-3" href="#"><fmt:message key="cabinet.gallery"/></a></li>
							<li><a class="show-4" href="#"><fmt:message key="cabinet.messages"/></a></li>
							<li><a rel="nofollow" href="controller?command=Logout"><fmt:message key="cabinet.logout"/></a></li>
						</ul>
						<!-- /.menu -->
						...
						<div class="row">
							...
							<div class="col-md-12 col-sm-12">
								<div class="toggle-content text-center" id="tab4">
									<h1 style="color: black"><fmt:message key="admin_page.transport"/></h1>
									<a href="controller?command=transport.BuyTransport"
										class="button big blue" style="margin-bottom: 2em"><fmt:message key="admin_page.buy_transport"/></a>
									<jsp:include page="../table_pages/table_of_transport.jsp" />
								</div>

								<div class="toggle-content text-center" id="tab5">
									<h1 style="color: black"><fmt:message key="admin_page.drivers"/></h1>
									<a href="controller?command=hr.HireDriver"
										class="button big blue" style="margin-bottom: 2em"><fmt:message key="admin_page.hire_driver"/></a>
									<jsp:include page="../table_pages/table_of_drivers.jsp" />
								</div>

								<div class="toggle-content text-center" id="tab6">
									<h1 style="color: black"><fmt:message key="admin_page.users"/></h1>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 footer">
				<p id="footer-text">
					<fmt:message key="cabinet.copyright"/>  &copy; 2015 <a href="#"><fmt:message key="cabinet.borshch"/></a>
				</p>
			</div>
			<!-- /.footer -->
		</div>
